...
import { years, flag, about } from "@/config/variables";
...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="h-full w-full flex justify-center p-8 lg:p-0"
    >
      <div className="md:max-w-[360px] lg:max-w-[1080px] w-full flex flex-col lg:flex-row justify-center items-center gap-16">
        <div className="hidden lg:flex relative justify-center items-center w-1/4 h-full">
          <motion.div
            ...
            animate="animate"
          >
            <h2 className="text-6xl text-violet-900 animate-pulse rotate-45">
              ?
            </h2>
          </motion.div>
          <motion.div
            ...
            animate="animate"
          >
            <h2 className="text-6xl text-white">{flag}</h2>
          </motion.div>
          <motion.div
            ...
            animate="animate"
          >
            <h2 className="text-4xl p-8 font-medium text-white text-center">
              {years} años
            </h2>
          </motion.div>
        </div>
